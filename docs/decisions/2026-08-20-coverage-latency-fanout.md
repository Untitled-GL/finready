...
**상태: 진행 중.** Phase 0·1·2 완료. **절편이 확정됐다 — 팬아웃이 유효하다.** Phase 3(classifier 팬아웃 구현)부터 이어간다.

## 다음 작업 (여기부터 읽는다)

Phase 2가 끝났다. 아래 "Phase 2 결과 (2026-08-25)"를 먼저 읽고, "Phase 3 — classifier 팬아웃" 설계를 그대로 구현한다.
