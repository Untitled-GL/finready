...
### 레이턴시 — classifier 43~51% 단축, 예측 그대로 맞아떨어졌다

| 시나리오 | classifier (Phase2→5) | 단축률 | 예측 |
|---|---|---|---|
| `CONS_A_001` | 14,504→7,171ms | **-50.6%** | 45~48% |
| `CONS_A_002` | 22,088→12,355ms | -44.1% | 〃 |
| `CONS_A_003` | 15,318→8,664ms | -43.4% | 〃 |
| `CONS_A_004` | 18,663→11,038ms | -40.9% | 〃 |
| `CONS_A_005` | 14,622→7,847ms | -46.3% | 〃 |

S1+S2 합계는 28~31% 단축(verifier는 안 쪼갰으니 희석 — 설계대로).
